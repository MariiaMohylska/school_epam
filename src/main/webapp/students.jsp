...
<body>
        <a href="/main"><img src="https://www.pngkit.com/png/full/31-316559_white-home-icon-no-background.png"
                   ...
                   <%=student.getBDay()%>
                                ...
                                <td>
                                        ...
                                        <form method="get" action="viewDetails">
                                                <input type="number" hidden name="StudentView"
                                                        value="<%=student.getId()%>" />
                                        ...
                                        <form method="post" action="deleteStudent">
                                                <input type="number" hidden name="StudentForDelete"
                                                        value="<%=student.getId()%>" />
                                                <input type="number" hidden name="classN"
                                                        value="<%=student.getClassNumber()%>" />
