   ...
   <table>
        <tr>
           <td>
            ...
            <td>
                <p><input type="text" name="surname" value="<%=studentName.getSurname()%>"></p>
            </td>
         </tr>
       <tr>
          <td>
          ...
          <td>
                <p><input type="text" name="name" value="<%=studentName.getName()%>"></p>
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
                <input type="text" name="fatherName" value="<%=studentName.getFatherName()%>"></p>
          </td>
        </tr>
                <tr>
                <td>
