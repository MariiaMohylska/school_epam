...
<body>
    <a href="/main"><img src="https://www.pngkit.com/png/full/31-316559_white-home-icon-no-background.png" width="50"
            height="50"></a>
    <br />
    <main>
        ...
        <table>
            ...
            <tr>
                <form method="get" action="editPersonalFile">
                    ...
                    <td>
                        <input type="number" hidden name="personalFileID"
                            value="<%=student.getPersonalFile().getId()%>" />
