...
<%@page import="model.entity.Phone"%>
...
<div class="main">
				<div class="main-section">
					...
					<%try{Phone phone = (Phone)request.getAttribute("phone");%>
   <form method="post" action="editPhone">
   <table>
        <tr>
           <td>
               <p> Phone number: &#9;</p>
            ...
            <td>
                <p><input type="text" name="phoneNumber" value="<%=phone.getPhone()%>"></p>
            </td>
         </tr>
                <tr>
                <td>
